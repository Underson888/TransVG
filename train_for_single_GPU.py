"""
@ author: neo
@ date: 2023-09-08  8:48 
@ file_name: train_for_single_GPU.py.PY
...
def main(args):
    # Removed utils.init_distributed_mode(args)
    ...
    # Removed model_without_ddp assignment related to distributed mode
    ...
    # Removed distributed check for samplers
